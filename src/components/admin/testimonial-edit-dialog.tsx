...
import { generateTestimonial } from '@/lib/ai';
...
export function TestimonialEditDialog({
  ...
  const handleAiGenerate = async (prompt: string) => {
    ...
    try {
      const result = await generateTestimonial(prompt);
      if (result) {
        setName(result.name);
          ...
          <ScrollArea className="h-[70vh] pr-6">
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="testimonial-name" className="text-right">
                  Author Name
                </Label>
                <Input
                  id="testimonial-name"
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="testimonial-title" className="text-right">
                  Author Title
                </Label>
                <Input
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="testimonial-rating" className="text-right">
                  Rating
                </Label>
