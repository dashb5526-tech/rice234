...
export function TestimonialsSectionEditDialog({ isOpen, setIsOpen, content, onSave }: TestimonialsSectionEditDialogProps) {
    ...
    const handleAiGenerate = async (promptText: string) => {
        ...
        try {
            const result = await generateContent({ topic: "customer testimonials", prompt: promptText });
            if (result) {
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="space-y-4 py-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea id="testimonials-description" value={currentContent.description} onChange={(e) => handleContentChange('description', e.target.value)} />
                        </div>
                    </div>
                    <DialogFooter>
